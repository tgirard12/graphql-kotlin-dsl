...
class ExecutionTest : WordSpec() {
        ...
        private val graphQl = schemaDsl {
            ...
            mutation<User> {
                ...
                .type("QueryType", { t ->
                    ...
                    ).dataFetcher("users", AsyncDataFetcher<List<User>>({ users })
                    ).dataFetcher("typeByNames", AsyncDataFetcher<List<SimpleTypes>>({ e ->
                ...
                .type("MutationType", { t ->
                    t.dataFetcher("updateUser", AsyncDataFetcher<User>({ e ->
    ...
    init {
        "Query execution" should {
            "query users" {
                val users = graphQl.executeAsync(
                        ExecutionInput.newExecutionInput()
                                ...
                                .build())
                        .get()
                        .getData<Map<String, List<Map<String, Any>>>>()["users"]!!
            ...
            "query user by id" {
                val user = graphQl.executeAsync(
                        ExecutionInput.newExecutionInput()
                                ...
                                .build())
                        .get()
                        .getData<Map<String, Map<String, Any>>>()["user"]!!
            ...
            "query simpleType" {
                val types = graphQl.executeAsync(
                        ExecutionInput.newExecutionInput()
                                ...
                                .build())
                        .get()
                        .getData<Map<String, List<Map<String, Any>>>>()["typeByNames"]!!
